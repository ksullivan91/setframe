      ...
      {exercisesQuery.isLoading ? (
        ...
        <>
          <Select
            ...
            /* `setParams` rather than replacing to an absolute path: this
               screen is mounted twice — inside the Progress stack and above
               the workout logger — and a hardcoded `/exercise-history/:id`
               would throw whoever switched exercise out of the Progress tab
               and into the logger's stack. Updating the param stays put. */
            onChange={(value) => router.setParams({ exerciseId: value })}
          />
