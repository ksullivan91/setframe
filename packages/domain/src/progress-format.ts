...
/** Saturday of a Sunday-anchored week, as a `YYYY-MM-DD` string. */
...
/** Sunday–Saturday range for a week-start date, e.g. "Aug 23–29" or, across
 * a month boundary, "Aug 30 – Sep 5". Setframe's one week-start rule lives in
 * `week.ts` and is Sunday; every weekly aggregation in the product imports it
 * from there, and this formatter just makes the boundary visible in copy. */
